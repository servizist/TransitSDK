...
public class Departure implements Serializable {
    ...
    public Departure(String lineId, String runId, String carrierId, String carrierName, String comCode, String waypointId,
                     TransportType transportType, DateTime scheduledTime, DateTime estimatedTime, Integer dueIn,
                     String delay, Integer delayInSeconds, String destinationDE, String destinationIT, Long lastTxTime,
                     String lastTxPoint, String viaIT, String viaDE, List<ViaInfo> viaInfo, List<String> additionalInfoIT,
                     List<String> additionalInfoDE, Boolean isCancelled, String laneDE, String laneIT) {
        this.lineId = lineId;
        this.runId = runId;
